...
export function buildGenerationPrompt({
  ...
  const system = [
    ...
    "- Never reproduce one of the example sentences, in whole or in part. Changing a name, a pronoun or a number in one of their sentences is reproducing it, and so is translating it and back.",
    "- Use different subjects, vocabulary and sentence shapes from the examples and from each other, so the learner has to apply the rule rather than recall an answer they were given.",
    "",
    `Each of the ${EXERCISE_COUNT} exercises:`,
    "- Tests one thing, and that thing is the weak point. Never a sentence needing several unrelated corrections at once.",
    "- Is one short sentence in ordinary everyday vocabulary, with one clear checkable answer — other correct answers may exist, but there must be an obvious one.",
    "",
    ...
    "- gradingNotes: English, always, and at most twelve words. It is a hint to the grader, not an explanation for it, and no learner ever sees it. Long notes cost the learner seconds of waiting for text nobody reads.",
    "",
    "What not to do:",
    "- Do not explain the grammar, and do not give the answer away inside the prompt. This is practice, not a lesson; the explanation comes after the learner has answered.",
