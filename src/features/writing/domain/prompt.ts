...
export function buildReviewPrompt({
  ...
  const system = [
    ...
    "- Rewrite the whole text correctly and naturally, keeping the learner's meaning, voice and length.",
    ...
    "- Do not invent problems to seem thorough. A short, honest list is the useful one.",
